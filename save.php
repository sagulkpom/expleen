...
$user_id=$_SESSION['id'];
	...
	$query = "INSERT INTO `images`(`user_id`, `dt_created`, `image`, `editor_code`,`flowchart_name`,`flowchart_category`,`flowchart_description`,`flowchart_image1`,`flowchart_image2`,`flowchart_iframe`,`flowchart_pdf`) VALUES ($user_id,now(),'$img_name','$image_code','$flowchart_name','$flowchart_category','$flowchart_description','$img_name1','$img_name2','$flowchart_iframe','$pdf_name')";
