...
$i++;
    ...
    <div class="col-sm-8">
      ...
      <h5 >Flowchart Name</h5>
       ...
       <input type="text" name="flowchart_name" id="flowchart_name" placeholder="Flow Chart Name" style="width:100%;margin-bottom:10px;" required>
...
<button id="redo-button" type="button" class="btn btn-success" style="margin-left:5px;width:70px;margin-bottom:5px;" title="redo"><i class="fa fa-repeat"></i></button>
  ...
  <div id="paper" class="paper"></div></div>
       ...
       <textarea name="flowchart_description" placeholder="Flowchart Description"></textarea>
   <input type="submit" class="btn btn-success" id="btnSave" value="Save Expleen" style="text-align:center;margin:20px auto;display:block;width:25%;float:right;height:60px;"/>
 ...
 <p>
           <input type="hidden" name="tags" id="mySingleField" required>
         </p>
 ...
 <h5 style="clear:both;">Upload Pdf File</h5>
   ...
   <textarea name="flowchart_iframe" placeholder="Youtube/Vimeo Iframe"></textarea>
...
var json_new_string=JSON.stringify(graph); 
 ...
 $('body').waitMe('hide');
      ...
      $('#result').html("<div class='alert alert-success'>Your Flowchart has been saved Successfully.<a href='show_flowchart.php?id="+response+"&title="+flow_name+"'>Click here to View Your Flowchart</a></div>");
