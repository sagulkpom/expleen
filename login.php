...
if(data.indexOf('tr') != -1){
  $('body').waitMe('hide');
$('#forgot_result').html('<div class="alert alert-success">Your password has been sent by an email. It may take a few minutes. The email may arrive in your Spam/Junk folder.</div>');
}
else
{
   $('body').waitMe('hide');
